...
export const SUSPECT_QA = [
  ...
  {
    "id": "alibi",
    "topic_hint": "my whereabouts that evening",
    "responses": [
    ...
    "questions": [
      ...
      "Give me a full account of your movements that evening.",
      "Were you with your guests the whole time?"
    ]
  },
  {
    "id": "lastseen",
    "topic_hint": "when I last saw Charles",
    "responses": [
    ...
    "questions": [
      ...
      "What time did Charles leave the drawing room?",
      "When did you last speak with Charles?"
    ]
  },
  {
    "id": "party",
    "topic_hint": "the evening itself",
    "responses": [
  ...
  {
    "id": "guests",
    "topic_hint": "who was in the house",
    "responses": [
  ...
  {
    "id": "argument",
    "topic_hint": "the quarrel at dinner",
    "responses": [
  ...
  {
    "id": "motive",
    "topic_hint": "the money he owed me",
    "responses": [
  ...
  {
    "id": "study_door",
    "topic_hint": "what I noticed that night",
    "responses": [
  ...
  {
    "id": "wellbeing",
    "topic_hint": "how I am bearing up",
    "responses": [
  ...
  {
    "id": "deny",
    "topic_hint": "whether I killed him",
    "responses": [
  ...
  {
    "id": "wine_cellar",
    "topic_hint": "my trip to the cellar",
    "responses": [
    ...
    "questions": [
      ...
      "Why did you go down to the cellar?",
      "Describe the wine cellar."
    ]
  },
  {
    "id": "east_corridor",
    "topic_hint": "the east corridor",
    "responses": [
    ...
    "questions": [
      ...
      "Did you set foot in the east wing that night?",
      "Were you near the study end of the house?"
    ]
  },
  {
    "id": "discovery",
    "topic_hint": "how he was found",
    "responses": [
    ...
    "questions": [
      ...
      "Who found Charles and when?",
      "Tell me how the body was discovered."
    ]
  },
  {
    "id": "witness_vivian",
    "topic_hint": "who can vouch for me",
    "responses": [
  ...
  {
    "id": "business",
    "topic_hint": "our business together",
    "responses": [
  ...
  {
    "id": "victim_character",
    "topic_hint": "what Charles was like",
    "responses": [
  ...
  {
    "id": "fingerprints",
    "topic_hint": "fingerprints on the opener",
    "responses": [
    ...
    "questions": [
      ...
      "Would we find your fingerprints on the murder weapon?",
      "Did forensics find your prints on the weapon?"
    ]
  },
  {
    "id": "phone_call",
    "topic_hint": "the telephone call",
    "responses": [
  ...
  {
    "id": "blood_doorknob",
    "topic_hint": "the blood on the door",
    "responses": [
  ...
  {
    "id": "harringtons",
    "topic_hint": "the Harringtons",
    "responses": [
      "The Harringtons? Friends of longer standing than I care to count, Inspector. They were on the drawing room settee all evening, well within sight, and neither of them has raised a voice in twenty years, let alone a blade.",
      "A thoroughly respectable couple, and thoroughly accounted for. They barely moved from the settee between dinner and... the rest of it.",
      "If your suspicions have reached the Harringtons, Inspector, the case is thinner than I feared. They came for the wine and the gossip, as they always do."
    ],
    "repeat_responses": [
      "The Harringtons are as I described them: present, pleasant, and blameless. Repetition will not make them sinister.",
      "Still the same Harringtons, Inspector. Ask them your questions; they will bore you honestly."
    ],
    "questions": [
      "Tell me about the Harringtons.",
      "Who are the Harringtons?",
      "What can you tell me about the Harrington couple?",
      "Where were the Harringtons that evening?",
      "Could the Harringtons have been involved?",
      "Did the Harringtons have any quarrel with Charles?"
    ]
  },
  {
    "id": "staff",
    "topic_hint": "the household staff",
    "responses": [
      "The staff were below stairs seeing to dinner and the washing-up, Inspector, as staff are on such an evening. Whether anyone marked my coming and going, you would have to ask them; I don't keep count of who watches me in my own house.",
      "They had the kitchen and the clearing-up to manage; a dinner for six keeps hands busy. I shouldn't think they saw anything of the drawing room, let alone the study.",
      "You are welcome to question the staff, Inspector. They have been with me for years, and they will tell you the same dull truth: dinner was served, plates were cleared, and nobody saw anything worth your notebook."
    ],
    "repeat_responses": [
      "As before, Inspector: the staff were at their work, and their work was not watching me.",
      "You have my answer on the staff. Question them and let mine rest."
    ],
    "questions": [
      "Tell me about the staff.",
      "Who works in the house?",
      "Did the staff see anything that night?",
      "Did the servants see you go to the cellar?",
      "Could one of the staff have done it?",
      "Were the servants in the kitchen all evening?"
    ]
  },
  {
    "id": "time_of_death",
    "topic_hint": "when Charles died",
    "responses": [
      "Your own people put it between half past nine and ten, Inspector; I have nothing better to offer than the coroner. All I can tell you is that the evening was perfectly ordinary until a quarter past ten, when it wasn't.",
      "Between half past nine and ten, or so I'm told. I learned the hour from your colleagues, not from anything I saw.",
      "I couldn't say precisely, and I rather think that's your department. He left us at half past nine; Daniel found him at a quarter past ten. The awful part fits somewhere in between."
    ],
    "repeat_responses": [
      "The window hasn't moved since you last asked, Inspector: half past nine to ten, by your own coroner's reckoning.",
      "I can't sharpen the hour for you. I wasn't there when it happened -- that is rather the point."
    ],
    "questions": [
      "What was the time of death?",
      "What time was he killed?",
      "When did Charles die?",
      "At what hour did Charles die?",
      "Do you know when the murder happened?",
      "How long had he been dead when he was found?",
      "When exactly did it happen?"
    ]
  },
  {
    "id": "intruder",
    "topic_hint": "whether someone broke in",
    "responses": [
      "The doors were bolted at dusk, Inspector, as they are every evening; nothing was taken, and no window so much as rattled. I wish I could hand you a convenient stranger, but whatever happened, it happened under my roof.",
      "No sign of it, or so your own men tell me. The house was shut up for the night and nothing is missing.",
      "A burglar who takes nothing and leaves the silver? You may search the grounds with my blessing, but I don't believe it any more than you do."
    ],
    "repeat_responses": [
      "Still no obliging stranger, Inspector. The doors were bolted and the house holds what it held.",
      "We've been over the locks and the windows. Nothing has changed except the hour."
    ],
    "questions": [
      "Could someone have broken in?",
      "Was there any sign of an intruder?",
      "Could an outsider have entered the house?",
      "Were the doors locked that night?",
      "Was anything stolen?",
      "Could a stranger have gotten inside?"
    ]
  },
  {
    "id": "heard_anything",
    "topic_hint": "what I heard",
    "responses": [
      "Nothing from the study, Inspector. It sits at the far end of the house, and with the talk and the laughter in the drawing room I heard nothing at all until Daniel cried out.",
      "No raised voices, no crash of furniture. Whatever happened in that room happened quietly, and the house kept it to itself.",
      "I have turned the evening over all night and there is nothing: talk, laughter, the clink of glasses, and then Daniel's cry. Nothing in between."
    ],
    "repeat_responses": [
      "Still nothing, Inspector, however hard you have me listen to my memory.",
      "As I said: nothing until Daniel cried out. The house is large and the party was loud."
    ],
    "questions": [
      "Did you hear anything unusual that night?",
      "Did anyone hear a struggle?",
      "Did you hear any noise from the study?",
      "Was there a scream or a shout?",
      "Did you hear anything strange before the body was found?",
      "Could you hear what was happening in the study?"
    ]
  },
  {
    "id": "lawyer",
    "topic_hint": "my solicitor",
    "responses": [
      "I have a solicitor, Inspector, as anyone with property does. I haven't telephoned him, if that's the question; innocent hosts generally don't -- though you are working hard to change my mind.",
      "If I want him, I shall send for him. That I haven't yet should tell you something about my conscience.",
      "You may take my answering you freely, without a solicitor at my elbow, however you like. I take it as the behaviour of a woman with nothing to hide."
    ],
    "repeat_responses": [
      "The solicitor remains unsummoned, Inspector. Give me a reason and that will change.",
      "As before: I speak for myself. If that changes, you will be the first to know."
    ],
    "questions": [
      ...
      "Should you be speaking to me without a lawyer?",
      "Do you want an attorney before we continue?"
    ]
  }
];
